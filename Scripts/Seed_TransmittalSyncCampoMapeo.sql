...
-- Catalogo: TiposDocumentos / EstatusDocumentos / EquivalenciaDiscipline / EquivalenciaTipoDocumento.
...
VALUES
(@IdTrabajo, @Codelco, @Salfa, 'DocumentNumber',   NULL,                   1, NULL, NULL,                 10),
(@IdTrabajo, @Codelco, @Salfa, 'Title',            NULL,                   1, NULL, NULL,                 20),
(@IdTrabajo, @Codelco, @Salfa, 'Revision',         NULL,                   1, NULL, NULL,                 30),
(@IdTrabajo, @Codelco, @Salfa, 'DocumentTypeId',   'doctype',              1, NULL, 'TiposDocumentos',    40),
...
(@IdTrabajo, @Codelco, @Salfa, 'Cwa_singleSelect',                    NULL,                                1, 'CWA00',     NULL,                         110),
...
(@IdTrabajo, @Codelco, @Salfa, 'TipoDeDocumento_singleSelect',        'TipoDeDocumento_singleSelect',      1, 'IAD-Informe de Avance Diario', 'EquivalenciaTipoDocumento', 200),
...
INSERT INTO TransmittalSyncCampoProyecto
    (IdTrabajo, ACXProjectIdOrigen, ACXProjectIdDestino, Campo, CampoOrigen, EsObligatorio, ValorDefault, Catalogo, Orden)
VALUES
(@IdTrabajo, @Salfa, @Codelco, 'DocumentNumber', NULL,             1, NULL, NULL,                10),
...
(@IdTrabajo, @Salfa, @Codelco, 'statusid',       'DocumentStatusId', 0, NULL, 'EstatusDocumentos', 50),
